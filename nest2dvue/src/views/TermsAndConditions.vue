<template>
    <div class="article-container">
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            ...
            opinions of <span class="highlight preview_company_name">Vova Stelmashchuk</span>,its agents and/or
            affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted
            by applicable laws, <span class="highlight preview_company_name">Vova Stelmashchuk</span> shall not be
            liable
            for the
        ...
        <p><span class="highlight preview_company_name">Vova Stelmashchuk</span> reserves the right to monitor all
            Comments
            and
        ...
        <p>You hereby grant <span class="highlight preview_company_name">Vova Stelmashchuk</span> a non-exclusive
            license to
            use,
        ...
        <p>No use of <span class="highlight preview_company_name">Vova Stelmashchuk</span>'s logo or other artwork will
            be
