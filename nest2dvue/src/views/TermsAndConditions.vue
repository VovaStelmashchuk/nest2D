<template>
  ...
  <p>We employ the use of cookies. By accessing <span class="highlight preview_website_name">nest2d</span>, you
    agreed to use cookies in agreement with the <span
        class="highlight preview_company_name">Vova Stelmashchuk</span>'s
    Privacy Policy.</p>
  ...
  <p>Unless otherwise stated, <span class="highlight preview_company_name">Vova Stelmashchuk</span> and/or its
    licensors
    own the intellectual property rights for all material on <span
        class="highlight preview_website_name">nest2d</span>.
    All intellectual property rights are reserved. You may access this from <span
        class="highlight preview_website_name">nest2d</span> for your own personal use subjected to
    restrictions set in these terms and conditions.</p>
  <p>You must not:</p>
  <ul>
    <li>Republish material from <span class="highlight preview_website_name">nest2d</span></li>
    <li>Sell, rent or sub-license material from <span class="highlight preview_website_name">nest2d</span>
    </li>
    <li>Reproduce, duplicate or copy material from <span class="highlight preview_website_name">nest2d</span>
    </li>
    <li>Redistribute content from <span class="highlight preview_website_name">nest2d</span></li>
  </ul>
  <p>This Agreement shall begin on the date hereof.</p>
  <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
    areas of the website. <span class="highlight preview_company_name">Vova Stelmashchuk</span> does not filter,
    edit,
    publish or review Comments prior to their presence on the website. Comments do not reflect the views and
    opinions of <span class="highlight preview_company_name">Vova Stelmashchuk</span>,its agents and/or affiliates.
    Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
    by applicable laws, <span class="highlight preview_company_name">Vova Stelmashchuk</span> shall not be liable
    for the
  ...
  <p><span class="highlight preview_company_name">Vova Stelmashchuk</span> reserves the right to monitor all Comments
    and
  ...
  <p>You hereby grant <span class="highlight preview_company_name">Vova Stelmashchuk</span> a non-exclusive license to
    use,
  ...
  <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of <span
        class="highlight preview_company_name">Vova Stelmashchuk</span>; and (d) the link is in the context of
    general
  ...
  <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to <span class="highlight preview_company_name">Vova Stelmashchuk</span>.
    Please
  ...
  <p>No use of <span class="highlight preview_company_name">Vova Stelmashchuk</span>'s logo or other artwork will be
