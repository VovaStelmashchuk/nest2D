<template>
    <div class="article">
        ...
        <p>
            ...
            use of
            <span class="highlight article__name">Vova Stelmashchuk</span>'s
            Website, located at
            <span class="highlight article__url">nest2d.online</span>.
        </p>
        <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use
            <span class="highlight article__site">nest2d</span> if you do not
        ...
        <p>
            ...
            <span class="highlight article__name">Vova Stelmashchuk</span>; and
